...
for x in range(0,10):
    ...
    #train model
    logreg.fit(traindataX, traindataY) #fit logreg using X and Y's train data
    
    #print("Model started") 
   
    
    predictionsproba = logreg.predict_proba(testdataX)[:,1]
...
plt.title('Receiver Operating Characteristic Logistic Regression Custom Split')
