...
for x in range(0,10):
    ...
    #train model
    forest.fit(traindataX, traindataY) #fit the data using X and Y
    #print("Model started") 
   
    
    predictionsproba = forest.predict_proba(testdataX)[:,1]
...
plt.title('Receiver Operating Characteristic Random Forest Custom Split')
